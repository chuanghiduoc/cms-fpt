...
import { User, UserUpdateInput, Department } from '@/types/user';
...
export default function UserEditModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Chỉ thêm mật khẩu vào payload nếu người dùng nhập mật khẩu mới
      ...
      setError(err instanceof Error ? err.message : 'Đã xảy ra lỗi khi cập nhật người dùng');
    } finally {
      setLoading(false);
    }
  };
