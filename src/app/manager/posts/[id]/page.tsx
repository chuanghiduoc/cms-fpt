    ...
    <div className="space-y-6 pb-8">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center">
          <Link href="/manager/posts" className="mr-4 text-gray-500 hover:text-gray-700 cursor-pointer">
        ...
        <div className="flex space-x-3">
          <Link href={`/manager/posts/edit/${post.id}`}>
            <button className="inline-flex items-center px-3 py-2 border border-gray-300 shadow-sm text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-400 cursor-pointer">
