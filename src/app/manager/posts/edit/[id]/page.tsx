            ...
            <form className="p-6 space-y-6" onSubmit={handleSubmit}>
              <div>
                ...
                <input
                  ...
                  className="block w-full rounded-md border border-gray-300 py-2 px-3 shadow-sm focus:outline-none focus:ring-orange-500 focus:border-orange-500 sm:text-sm text-gray-900 cursor-text"
